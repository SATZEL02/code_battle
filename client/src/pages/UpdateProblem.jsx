...
export default function UpdateProblem() {
    ...
    return (
      ...
      hover:file:bg-violet-100" type="file" id="finalInput" accept=".txt" onChange={handleChange} />
      ...
      file:text-sm file:font-semibold
      file:bg-violet-50 file:text-violet-700
      hover:file:bg-violet-100" type="file" id="finalOutput" accept=".txt" onChange={handleChange} />
